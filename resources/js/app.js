...
const i18n = createI18n({
  ...
  messages: {
    'koKR': {
      ...
      supply_text: 'SNP Tec Corp.는 다양한 프로파일의 전자 장비 및 장비 제조업체의 요구에 따라 전자 부품 소싱이 가능합니다.',
      supply_p2: '',
      supply_key_features: '주요 특징:',
      supply_feature_1: '제품 품질에 대한 100% 신뢰',
      supply_feature_2: '최저가 공급 가격',
      supply_feature_3: '빠른 배송',
      supply_feature_4: '소량 주문 가능',
      supply_feature_5: '전 세계 어디서나 제공',
      supply_feature_6: '기술지원',
      contact_address: '주소',
      contact_tel: '전화 & 팩스',
      tel: '02-2101-2056',
    ...
    'enUS': {
      ...
      about_company_name: 'SNP Tec Corp., Ltd',
      ...
      supply_text: 'SNP Tec Corp. engages in the supply of electronic components for the needs of manufacturers of electronic equipment and equipment of a wide range of profiles.\nOur customers receive benefits when ordering parts from us:\n100% confidence in product quality.\nAffordable price.\nTimely delivery.',
      supply_p2: 'SNP Tec Corp. supplies components and materials for the production and repair of electronic equipment for any purpose.',
      supply_key_features: 'Key Features:',
      supply_feature_1: 'Flexible forms of payment',
      supply_feature_2: 'Short delivery times',
      supply_feature_3: 'Order from 1 piece',
      supply_feature_4: 'Checking the quality of supplied products',
      supply_feature_5: 'Delivery anywhere, worldwide',
      supply_feature_6: 'Technical support',
